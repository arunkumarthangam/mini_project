<?php
	...
	if($_POST['count']=='1'){
		...
		$query=mysqli_query($con,"select * from clg_tran where Gr_num ='".$grn['sch_src_grn']."'");
	}
	else{
		$id=mysqli_fetch_assoc(mysqli_query($con,"SELECT * from user_clg	
			where Gr_num='".$_POST['sch_src']."'
		")
		);
			$query=mysqli_query($con,"select * from clg_tran where Gr_num ='".$_POST['sch_src']."'");
	}
	if(!$id){
		?>
	...
	<div class="main-container">
		...
		<div class="post-content">
			<div class="post-text">
				...
				<div class="box-right" >
					Gr/Sr Number: <span class="form-text src_grn"><b><?php echo $id['Gr_num'];?></b></span>
				</div>
				<div class="box-left">
					Medium:<span class="form-text"> <b><?php echo $id['Medium'];?></b></span>
				</div>
				<div class="box-right">
					Course:<span class="form-text"> <b><?php echo $id['course'];?></b></span>
				</div>
				<div class="box-left">
					Year: <span class="form-text"><b><?php echo $id['Std'];?></b><span>
				</div>
				<div class="box-right">
...
?>
				...
				<?php
						...
						$i++; 
				?>
				<ul class="table-view <?php echo 'delete-fee-'.$i?>">
