	...
	<div class="post-content">
		<div class="post-text">
				...
				<form class="fee_chng_form" name="fee-change"  method="POST">
					...
					<div class="box-left">
						Base Fees:<b><span class="form-text fee_chng_form_hide_1"></span></b>
						<b><span class="form-text fee_chng_form_hide_4" style="display:none;"></span></b>
					</div>
					<div class="box-right">
						Late Fees(per day):<b><span class="form-text fee_chng_form_hide_5" style="display:none"> </span></b>
					</div>
					<div class="box-left">
						Actual Late Fee:<b><span class="form-text fee_chng_form_hide_2" style="display:none;"></span></b>
						<b><span class="form-text fee_chng_form_hide_3" style="display:none;"></span></b>
					</div>
					<div class="box-right">
						Last date for Fee:<b><span class="form-text fee_chng_form_last_date"></span></b> 
					</div>
					<div class="box-left">
						Total Amount payable:<b><span class="form-text fee_chng_form_tot_am"></span> </b>
					</div>
					<div class="box-right">
						<button class="sch_fee_verify"><span>Add fees</span></button>
					</div>
					<div class="fee_str" style="display:none">
					</div>
				</form>
		</div>
		</div>
