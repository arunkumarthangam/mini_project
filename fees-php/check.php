<?php
	...
	$check=mysqli_fetch_row(mysqli_query($con,"select uname,name,type from admin_sch where uname='".$set['login-uname']."' AND pwd='".md5($set['login-pwd'])."' AND type='".$set['login-utyp']."'"));
